...
class benchioSmallTest(rfm.RegressionTest):
    ...
    allref = {
        "nvme": {
            1: {"cyclone:cpu": {"unstriped_mpiio": (1.1, -0.8, 0.8, "GB/s")}},
            2: {
                "cyclone:cpu": {"unstriped_mpiio": (1.6, -0.8, 0.8, "GB/s")},
            },
        },
        "scratch": {
            1: {
                "cyclone:cpu": {"unstriped_mpiio": (1.4, -0.8, 0.8, "GB/s")},
            },
            2: {
                "cyclone:cpu": {"unstriped_mpiio": (2.5, -0.8, 0.8, "GB/s")},
            },
        },
    }
    ...
    def __init__(self, **kwds):
        ...
        self.perf_patterns = {
            "unstriped_mpiio": sn.extractsingle(
